  ...
  return (
    <div className="me subcontainer">
      ...
      <ul className="contact">
          <li className="contact-method"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" width="18px" height="18px"><path d="M0 0h24v24H0z" fill="none"/><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg><span class="default">Print to see my number</span><span class="only-in-print">(+852) 9349 1019</span></li>
      ...
      <div className="intro">
          ...
          <p><strong>{">"}</strong> I have 5 years' experience in data science: 3 years' work experience and 2 years' research experience.</p>
      </div>
    </div>
  );
}